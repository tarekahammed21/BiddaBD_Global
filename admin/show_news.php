                             ...
                             <tbody>
                                 <?php while ($element = mysqli_fetch_assoc($item)) { ?> 
                                     <tr>
                                         ...
                                         <td><img src="storage/add_news//<?php echo $element['image']; ?>" alt="slider image" style="width:100px; height:100px;"></td>
                                         <th><?php echo $element['heading']; ?></th>
                                         <th><?php echo $element['details']; ?></th>

                                         <td><a class="btn btn-danger" href="delete_news.php?data=delete&&news_id=<?php echo $element['id']; ?>" role="button"><i class="fa fa-trash"></i></a></td>
                                     </tr>
                                 <?php } ?>
                             </tbody>
                         </table>
